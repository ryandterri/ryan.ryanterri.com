export const contact_links = [
  ...
  {
    icon: 'mdi-web',
    value: 'https://resume.ryanterri.com',
    link: 'https://resume.ryanterri.com',
    target: '_blank'
  },
]
export const profile = {
  ...
  headline: '',
  description: 'Senior Software Architect / Full Stack Developer with 15+ years building scalable applications in Node.js, Vue.js, and MongoDB. Proven leadership in architecting APIs, internal tools, and customer-facing apps. Passionate about clean code, modern front-end architecture, and DevOps-aware design.',
}
export const work_history = [
  {
    company: 'Compare Power',
    title: 'IT Architect',
    dates: 'February 2021 - Present',
    description: 'Creating full stack solutions for both customer facing and internal systems.  Using primarily nodejs, MongoDb and VueJs'
  },
  {
    company: 'Stratum Reservoir',
    title: 'IT Architect',
    dates: 'January 2020 - February 2021',
    description: 'Developed an api and frontend for serving analytical data for clients. Built with nodejs and mongodb and secured with jwt tokens.'
  },
  {
    company: 'Gexa Energy',
    title: 'IT Architect',
